            ...
            messages: [
                {
                    ...
                    content: `
                        ...
                        Правила:
                        - обычно слышится имя и время, например: Вадим с шести или Галя с часу, тогда ищешь по имени
                        - если говорят в добавок должность например: Саша барбек с шести; Саша менеджер с часу проверяй, скорее всего в базе два сотрудника с одинаковым именем и тогда смотри по должности 
                        ...
                        - Добавь поле "shiftStart" в формате часа без ведущего нуля (например: "9", а не "09") для начала смены работника, учитывай что ресторан открывается с 8, и время записывается по европейским стандартам, если у нас работник приходит в час то записываем 13, если с шести, то это вечерняя смена и пишем 18, продумывай такие моменты.
