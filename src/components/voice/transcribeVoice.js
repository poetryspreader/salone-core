            ...
            messages: [
                {
                    ...
                    content: `
                        ...
                        Правила:
                        - Используй должность только если пользователь её назвал или она нужна для различения одинаковых имён.
                        - Если имя уникальное, выбирай работника только по имени.
